...
class MLPFactor(NeuralFactor):
    ...
    def make(input_variables, *hidden_layer_sizes_and_output_variable):
        hidden_layer_sizes, output_variable = \
            MLPFactor.validate_arguments(input_variables, hidden_layer_sizes_and_output_variable)
        neural_net = MLPFactor.make_neural_net(input_variables, hidden_layer_sizes, output_variable)
    ...
    def make_neural_net(input_variables, hidden_layer_sizes, output_variable):
        all_layer_sizes = MLPFactor.compute_mlp_all_layer_sizes_list(input_variables, hidden_layer_sizes, output_variable)
        neural_net = MLP(*all_layer_sizes)
        return neural_net

    @staticmethod
    def compute_mlp_all_layer_sizes_list(input_variables, hidden_layer_sizes, output_variable):
    ...
    def validate_arguments(input_variables, args):
        try:
            ...
            assert \
                ...
                and \
                all(isinstance(i, int) for i in hidden_layer_sizes) \
                and \
                isinstance(output_variable, DiscreteVariable)
        except Exception:
            raise Exception(
