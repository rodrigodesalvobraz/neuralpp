...
def main():
    ...
    def get_estimate_and_time(model, number_of_samples):
        start = timer()
    ...
    data = list_for_each(numbers_of_samples,
                         ...
                         list_for_each(range(number_of_estimations),
                                       ...
                                       body=
                                       lambda estimation:
                                       list_for_each(models,
                                                     lambda model:
                                                     get_estimate_and_time(model, number_of_samples)),
    ...
    assert len(data[0][0]) == len(models)
