from neuralpp.inference.graphical_model.representation.frame.dict_data_loader import DictDataLoader, BatchSizeMustBeGreaterThanZero
from neuralpp.inference.graphical_model.representation.frame.dict_frame import DictionaryShouldHaveAtLeastOneItem, \
