from inference.graphical_model.representation.factor.product_factor import ProductFactor
from inference.graphical_model.variable.variable import Variable
