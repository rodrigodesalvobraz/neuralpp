...
from inference.graphical_model.representation.frame import dict_frame
from inference.graphical_model.representation.frame.dict_frame import convert_scalar_frame_to_tensor_frame, \
    convert_values_to_at_least_two_dimensions
from inference.graphical_model.representation.representation import contains_batch_coordinate
from inference.graphical_model.variable.discrete_variable import DiscreteVariable
from util import util
from util.util import join, find
