...
from util.log_util import log_without_inf_non_differentiable, log_of_nested_list_without_inf_non_differentiable
...
class PyTorchLogTable(PyTorchTable):
    ...
    def sum_out(self, dim):
        ...
        # since they are sums of potentials coming from exponentiations.
    ...
    def normalize(self):
        ...
        # we can use log directly because the normal-space raw tensor came from exponentiation
